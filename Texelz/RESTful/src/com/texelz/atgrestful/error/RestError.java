 ...
 */
package com.texelz.atgrestful.error;

import java.util.LinkedHashMap;
import java.util.Map;

import com.texelz.atgrestful.http.HttpStatus;
import com.texelz.atgrestful.lang.ObjectUtils;
...
public class RestError {
	...
	public int hashCode() {
		return ObjectUtils
				.nullSafeHashCode(getStatus(), getCode(), getMessage(), getDeveloperMessage(), getThrowable());
	}
